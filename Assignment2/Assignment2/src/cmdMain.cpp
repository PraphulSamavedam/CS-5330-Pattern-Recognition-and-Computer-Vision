...
This file is command line based program and takes 5 mandatory arguments
...
int main(int argc, char* argv[]) {
	...
	if (argc < 5)
	{
		printf("Usage: %s <targetFilePath> <imagesDatabasePath> <featureTechnique> <distanceMetric> <NumberOfSimilarImages> <[optional]resetFile> <[optional]echoStatus>\n Aborting with exit code: -100\n", argv[0]);
		exit(-100);
	}
