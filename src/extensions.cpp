...
/** This function is better at recognizing the edges in an image.
	...
	*		 -100 if the source and destinations are of different sizes.
	*		 -101 if the source and destinations are of different types.
	* @note: OpenCV functions are used for this purpose.
	*/
...
/** This function provides a negative image of the image provided in 16S format.
* @param given_image image whose negative has to be obtained.
* @return negative of the given image as values inverted for each color 
*/
