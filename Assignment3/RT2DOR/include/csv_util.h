/*
  ...
  Modified by : Samavedam Manikhanta Praphul
...
/*
  ...
  floating point numbers as the remaining columns, this function
  returns the filenames, label names as a std::vector of character arrays, and the
  remaining data as a 2D std::vector<float>.
  ...
  The function returns a non-zero value if something goes wrong.
  @note: @Overloaded to return labels from the original function.
 */
