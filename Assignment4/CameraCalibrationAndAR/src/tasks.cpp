...
bool buildVirtualObjectPoints(std::vector<cv::Vec3f>& vir_obj_object_pts, char object) {
	...
	{	// Calculate for the bottom square
		...
		vir_obj_object_pts.push_back(cv::Vec3f(2, -3, 0));
		vir_obj_object_pts.push_back(cv::Vec3f(5, -1, 0));

		// Calculate for the top square
		vir_obj_object_pts.push_back(cv::Vec3f(2, -1, 4));
		vir_obj_object_pts.push_back(cv::Vec3f(2, -3, 4));
		vir_obj_object_pts.push_back(cv::Vec3f(5, -1, 4));
...
bool drawVirtualObject(cv::Mat& image, std::vector<cv::Vec2f>& vir_obj_img_pts, char object) {
	...
	{
		// Draw the base floor
		cv::line(image, cv::Point2f(vir_obj_img_pts[0]), cv::Point2f(vir_obj_img_pts[1]), cv::Scalar(255, 0, 255), 2);
		cv::line(image, cv::Point2f(vir_obj_img_pts[1]), cv::Point2f(vir_obj_img_pts[2]), cv::Scalar(255, 0, 255), 2);
		cv::line(image, cv::Point2f(vir_obj_img_pts[2]), cv::Point2f(vir_obj_img_pts[3]), cv::Scalar(255, 0, 255), 2);
		cv::line(image, cv::Point2f(vir_obj_img_pts[3]), cv::Point2f(vir_obj_img_pts[0]), cv::Scalar(255, 0, 255), 2);

		// Draw the one wall
		cv::line(image, cv::Point2f(vir_obj_img_pts[1]), cv::Point2f(vir_obj_img_pts[5]), cv::Scalar(255, 0, 255), 2);
		cv::line(image, cv::Point2f(vir_obj_img_pts[5]), cv::Point2f(vir_obj_img_pts[6]), cv::Scalar(255, 0, 255), 2);
		cv::line(image, cv::Point2f(vir_obj_img_pts[6]), cv::Point2f(vir_obj_img_pts[2]), cv::Scalar(255, 0, 255), 2);

		//Draw the other wall
		cv::line(image, cv::Point2f(vir_obj_img_pts[0]), cv::Point2f(vir_obj_img_pts[4]), cv::Scalar(255, 0, 255), 2);
		cv::line(image, cv::Point2f(vir_obj_img_pts[4]), cv::Point2f(vir_obj_img_pts[7]), cv::Scalar(255, 0, 255), 2);
		cv::line(image, cv::Point2f(vir_obj_img_pts[7]), cv::Point2f(vir_obj_img_pts[3]), cv::Scalar(255, 0, 255), 2);
	...
	case 'a': // Asymmetric object
	{
		...
		cv::line(image, cv::Point2f(vir_obj_img_pts[4]), cv::Point2f(vir_obj_img_pts[5]), cv::Scalar(255, 0, 255), 2);
		cv::line(image, cv::Point2f(vir_obj_img_pts[5]), cv::Point2f(vir_obj_img_pts[6]), cv::Scalar(255, 0, 255), 2);
		cv::line(image, cv::Point2f(vir_obj_img_pts[6]), cv::Point2f(vir_obj_img_pts[4]), cv::Scalar(255, 0, 255), 2);
		...
		// Making assymetrical 
		cv::line(image, cv::Point2f(vir_obj_img_pts[2]), cv::Point2f(vir_obj_img_pts[7]), cv::Scalar(255, 0, 0), 2);
		cv::line(image, cv::Point2f(vir_obj_img_pts[7]), cv::Point2f(vir_obj_img_pts[6]), cv::Scalar(0, 0, 255), 2);
	...
	case 't': // Triangle base Cube like structure.
	{
		...
		cv::line(image, cv::Point2f(vir_obj_img_pts[0]), cv::Point2f(vir_obj_img_pts[1]), cv::Scalar(0, 255, 0), 2);
		cv::line(image, cv::Point2f(vir_obj_img_pts[1]), cv::Point2f(vir_obj_img_pts[2]), cv::Scalar(0, 255, 0), 2);
		cv::line(image, cv::Point2f(vir_obj_img_pts[2]), cv::Point2f(vir_obj_img_pts[0]), cv::Scalar(0, 255, 0), 2);

		// Draw the top triangle
		cv::line(image, cv::Point2f(vir_obj_img_pts[3]), cv::Point2f(vir_obj_img_pts[4]), cv::Scalar(0, 255, 0), 2);
		cv::line(image, cv::Point2f(vir_obj_img_pts[4]), cv::Point2f(vir_obj_img_pts[5]), cv::Scalar(0, 255, 0), 2);
		cv::line(image, cv::Point2f(vir_obj_img_pts[5]), cv::Point2f(vir_obj_img_pts[3]), cv::Scalar(0, 255, 0), 2);

		// Draw the connecting lines
		cv::line(image, cv::Point2f(vir_obj_img_pts[0]), cv::Point2f(vir_obj_img_pts[3]), cv::Scalar(0, 255, 0), 2);
		cv::line(image, cv::Point2f(vir_obj_img_pts[1]), cv::Point2f(vir_obj_img_pts[4]), cv::Scalar(0, 255, 0), 2);
		cv::line(image, cv::Point2f(vir_obj_img_pts[2]), cv::Point2f(vir_obj_img_pts[5]), cv::Scalar(0, 255, 0), 2);
